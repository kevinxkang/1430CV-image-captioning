...
class ImageCaptioningModel:
    ...
    def build_model(self):
        ...
        transformer_layer1 = MultiHeadAttention(num_heads=8, key_dim=self.embedding_dim)
        ...
        transformer_layer2 = MultiHeadAttention(num_heads=8, key_dim=self.embedding_dim)
